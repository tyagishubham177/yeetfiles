...
| Delete-friction checkpoint | Remove redundant app-level delete friction while staying honest about system confirmation | Real-device short-session validation |
